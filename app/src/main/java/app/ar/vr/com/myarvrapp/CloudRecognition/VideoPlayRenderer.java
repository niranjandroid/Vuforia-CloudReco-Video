...
import app.ar.vr.com.myarvrapp.CloudRecognition.VideoPlay.KeyFrameShaders;
import app.ar.vr.com.myarvrapp.CloudRecognition.VideoPlay.VideoPlaybackShaders;
import app.ar.vr.com.myarvrapp.CloudRecognition.VideoPlay.VideoPlayerHelper;
import app.ar.vr.com.myarvrapp.SampleApplication.SampleAppRenderer;
import app.ar.vr.com.myarvrapp.SampleApplication.SampleAppRendererControl;
import app.ar.vr.com.myarvrapp.SampleApplication.SampleApplicationSession;
import app.ar.vr.com.myarvrapp.SampleApplication.utils.SampleMath;
import app.ar.vr.com.myarvrapp.SampleApplication.utils.SampleUtils;
...
public class VideoPlayRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl {
    ...
    public void requestLoad(String movieName, int seekPosition,
        ...
        Log.d("niranjan123 ", "reequest load " + movieName + " " + seekPosition);
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        Log.d("niranjan143", "on Surface changed " + mMovieName + " " + gl);
        if(gl == null) {
    ...
    public void onDrawFrame(GL10 gl) {
        Log.d("niranjan14", "on DrawFrame "+mSeekPosition +" "+ (currentStatus == VideoPlayerHelper.MEDIA_STATE.PAUSED));
        if (!mIsActive)
            return;
        if (mVideoPlayerHelper != null) {
    ...
    public void renderFrame(State state, float[] projectionMatrix) {
        //Log.d("niranjan1234", "rendering frame");
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
           ...
           // Log.d("niranjan1234", mSeekPosition +" "+ (currentStatus == VideoPlayerHelper.MEDIA_STATE.PAUSED));
