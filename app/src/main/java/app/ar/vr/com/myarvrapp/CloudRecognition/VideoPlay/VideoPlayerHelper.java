...
package app.ar.vr.com.myarvrapp.CloudRecognition.VideoPlay;
    ...
    OnBufferingUpdateListener, OnCompletionListener, OnErrorListener
{
    ...
    {
        Log.d("niranjan12345", "movie loading " + filename);
        ...
        {
            Log.d("niranjan12345", "Already loaded");
        } else
        {
                                                                                   ...
                                                                                   // ICS device
            {
                ...
                } else
                {
                    ...
                    {
                        Log.e("niranjan12345", "Error while creating the MediaPlayer: "
                            + e.toString());
